...
export default function Blog() {
  ...
  const createBlog = () =>{
    ...
    axios
  .post('http://localhost:3000/bloguser/blogadd',  blogObj )
  ...
  const getAllBlogs = () => {
    const apiUrl = 'http://localhost:3000/bloguser/blogget';
            ...
            <div class="modal-dialog">
              <div class="modal-content">
                ...
                <div class="modal-footer">
                  ...
                  <button type="button" onClick={()=> createBlog()} class="btn btn-primary" data-bs-dismiss="modal">
                    Create Blog
                  </button>
                </div>
              </div>
