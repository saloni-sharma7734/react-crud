          ...
          <div class="carousel-item active">
            <div class="row">
              <div class="col-lg col-sm-12 col-md-6 mt-5 mb-5">
                <div class="card">
                  <img className="card-img-top" src={image1} alt="vgjvhbkj" md-3 /><div class="carousel-caption d-none d-md-block">
                    {/* <h5>First slide label</h5> */}
                    <p className="p1">Why Avoiding Programing Is Bad For Your Business</p>
                    {/* <p className="p2">Jan 10, 2022</p> */}
                  </div>
                </div>
